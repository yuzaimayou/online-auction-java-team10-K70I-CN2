...
public class BidHistoryApiClient {

    private static volatile BidHistoryApiClient instance;
    private final HttpClient httpClient = HttpClientProvider.get();
    private final Gson gson = GsonUtil.getInstance();

    public static BidHistoryApiClient getInstance() {
        if (instance == null) {
            synchronized (BidHistoryApiClient.class) {
                if (instance == null) {
                    instance = new BidHistoryApiClient();
                }
            }
        }
        return instance;
