...
public class AuctionTableCellFactory {

    private static final Insets CELL_PADDING = new Insets(0, 0, 0, 20);
    private static final DateTimeFormatter DATE_FMT = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    private static final DateTimeFormatter TIME_FMT = DateTimeFormatter.ofPattern("hh:mm a");

    private AuctionTableCellFactory() {}
    public static Callback<TableColumn<ItemSummary, ItemSummary>, TableCell<ItemSummary, ItemSummary>>
    itemCell(double thumbW, double thumbH) {
        return column -> new TableCell<>() {
            ...
            {
                img.setFitWidth(thumbW);
                img.setFitHeight(thumbH);
    ...
    public static Callback<TableColumn<ItemSummary, String>, TableCell<ItemSummary, String>>
    sellerCell() {
        ...
        return col -> new TableCell<>() {
            ...
            protected void updateItem(String category, boolean empty) {
                ...
                label.getStyleClass().removeAll(
                        "cat-fashion", "cat-electronics",
                        "cat-home", "cat-art", "cat-jewelry"
                );
    ...
    public static Callback<TableColumn<ItemSummary, LocalDateTime>, TableCell<ItemSummary, LocalDateTime>>
    endTimeCell() {
        return col -> new TableCell<>() {
    ...
    public static Callback<TableColumn<ItemSummary, Void>, TableCell<ItemSummary, Void>>
    adminActionCell(Consumer<ItemSummary> onBan) {
        return column -> new TableCell<>() {
            ...
            protected void updateItem(Void item, boolean empty) {
                ...
                setGraphic(getTableRow().getItem().getStatus() == AuctionStatus.BANNED
                        ? bannedLabel
                        : banBtn);
            }
        };
    ...
    public static Callback<TableColumn<ItemSummary, ItemSummary>, TableCell<ItemSummary, ItemSummary>>
    sellerActionCell(
            Consumer<ItemSummary> onEdit,
            Consumer<ItemSummary> onDelete,
            Consumer<ItemSummary> onView
    ) {
        return column -> new TableCell<>() {
...

            {
                ...
                editBtn.setOnAction(e -> {
                    if (onEdit != null && current != null) onEdit.accept(current);
                });

                viewBtn.setOnAction(e -> {
                    if (onView != null && current != null) onView.accept(current);
                });

                deleteBtn.setOnAction(e -> {
                    if (onDelete != null && current != null) onDelete.accept(current);
                });
            }
